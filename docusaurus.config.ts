...
const config: Config = {
  ...
  organizationName: 'OceanApocalypse', // Usually your GitHub org/user name.
  projectName: 'oceanapocalypse.github.io', // Usually your repo name.
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/OceanApocalypse/',
          label: 'GitHub',
          position: 'right',
        },
      ],
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'GitHub',
              href: 'https://github.com/OceanApocalypse/oceanapocalypse.github.io',
            },
          ],
        },
      ],
